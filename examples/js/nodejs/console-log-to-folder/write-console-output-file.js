...
console.log('write-console-output-file.js config');

if (config.log_output && config.log_output.path) {
  init(config.log_output.path, config.log_output.filename);
} else {
  console.log('write-console-output-file.js not log_output path or filename');
}